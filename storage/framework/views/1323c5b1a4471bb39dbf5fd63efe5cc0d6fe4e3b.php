        ...
        <!-- Our Activities -->
            ...
            <div id="offredemploicontainer"  class="row">
                <div id="employchoix" class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 mt-2">
                   <img src="<?php echo e(asset('public/images/offredemploi/Artboard_cv.png')); ?>" alt="" class="rounded float-left pt-0" >  <!-- style="max-width: 10rem; max-height: 10rem; position: relative" -->
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/whitelineservices.dz/elsewedysite.whitelineservices.dz/resources/views/candidaturespantane2.blade.php ENDPATH**/ ?>