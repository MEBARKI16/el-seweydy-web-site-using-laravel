 ...
 <?php $__env->startSection('content'); ?>
  ...
  <!-- Background image -->
  <div id="intro-example" class="p-5 text-center bg-image pb-5 pt-5"
      ...
      <div class="d-flex justify-content-center align-items-center h-100" style="float: left;">
        <div class="text-white" style="text-align: left;">
          ...
          <a class="btn btn-outline-light btn-lg m-2" href="#"
            role="button" rel="nofollow" target="_blank">Voir les projets</a>
          <a class="btn btn-outline-light btn-lg m-2" href="<?php echo e(route('contact')); ?>"
            target="_blank" role="button">Nous contacter</a>
        </div>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/whitelineservices.dz/elsewedysite.whitelineservices.dz/resources/views/index.blade.php ENDPATH**/ ?>