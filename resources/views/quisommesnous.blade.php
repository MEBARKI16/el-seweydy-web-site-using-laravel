...
<div class="qsn-menu">
  ...
  <div class="vertical-menu-first">
    ...
    <div class="menu-item" id="cableDiv" onmouseenter="coloredCable(this)" onmouseleave="normalCable(this)" >
      <div class="menu-icon"><img id="cableImage" src="{{asset('public/images/cables et accessoires.png')}}" /></div>
    ...
    <div class="menu-item" id="electricDiv" onmouseenter="coloredElectric(this)" onmouseleave="normalElectric(this)">
      <div class="menu-icon"><img id="electricImage" src="{{asset('public/images/Produits electriques.png')}}"/></div>
    ...
    <div class="menu-item" id="compteursDiv" onmouseenter="coloredCompteurs(this)" onmouseleave="normalCompteurs(this)">
      <div class="menu-icon"><img id="compteursImage" src="{{asset('public/images/Compteurs.png')}}"/></div>
    ...
    <div class="menu-item" id="transformateursDiv" onmouseenter="coloredTransformateurs(this)" onmouseleave="normalTransformateurs(this)">
      <div class="menu-icon"><img id="transformateursImage" src="{{asset('public/images/Transformateurs.png')}}"/></div>
...
<div class="map">
<img id="productsMap" height="100%" src="{{asset('public/images/Map_All.png')}}"/>
</div>
<div class="qsn-menu">
  <div class="qsn-menu-inter">
  <div class="vertical-menu-last">
    ...
    <div class="menu-item" id="telDiv" onmouseenter="coloredTel(this)" onmouseleave="normalTel(this)">
      <div class="menu-icon"><img id="telImage" src="{{asset('public/images/Telcommunication.png')}}"/></div>
    ...
    <div class="menu-item" id="energieDiv" onmouseenter="coloredEnergie(this)" onmouseleave="normalEnergie(this)">
      <div class="menu-icon"><img id="energieImage" src="{{asset('public/images/Energies renouvelables.png')}}"/></div>
    ...
    <div class="menu-item" id="devDiv" onmouseenter="coloredDev(this)" onmouseleave="normalDev(this)">
      <div class="menu-icon"><img id="devImage" src="{{asset('public/images/Projet et developpement.png')}}"/></div>
    ...
    <div class="menu-item" id="exportationDiv" onmouseenter="coloredExportation(this)" onmouseleave="normalExportation(this)">
      <div class="menu-icon"><img id="exportationImage" src="{{asset('public/images/Exportation.png')}}"/></div>
...
<div class="qsn-menu-mobile">
  <a href="#">
    <div class="menu-item" id="cableDivClick" onmouseenter="coloredCable(this)" onmouseleave="normalCable(this)" onclick="coloredCableClick(this)" >
      <div class="menu-icon"><img id="cableImageClick" src="{{asset('public/images/cables et accessoires.png')}}" /></div>
    </div>
    </a>
    <a href="#">
    <div class="menu-item" id="electricDivClick" onmouseenter="coloredElectric(this)" onmouseleave="normalElectric(this)" onclick="coloredElectricClick(this)">
      <div class="menu-icon"><img id="electricImageClick" src="{{asset('public/images/Produits electriques.png')}}"/></div>
    </div>
    </a>
    <a href="#">
    <div class="menu-item" id="compteursDivClick" onmouseenter="coloredCompteurs(this)" onmouseleave="normalCompteurs(this)" onclick="coloredCompteursClick(this)">
      <div class="menu-icon"><img id="compteursImageClick" src="{{asset('public/images/Compteurs.png')}}"/></div>
    </div>
    </a>
    <a href="#">
    <div class="menu-item" id="transformateursDivClick" onmouseenter="coloredTransformateurs(this)" onmouseleave="normalTransformateurs(this)" onclick="coloredTransformateursClick(this)">
      <div class="menu-icon"><img id="transformateursImageClick" src="{{asset('public/images/Transformateurs.png')}}"/></div>
    </div>
    </a>
    <a href="#">
    <div class="menu-item" id="telDivClick" onmouseenter="coloredTel(this)" onmouseleave="normalTel(this)" onclick="coloredTelClick(this)" >
      <div class="menu-icon"><img id="telImageClick" src="{{asset('public/images/Telcommunication.png')}}"/></div>
    </div>
    </a>
    <a href="#">
    <div class="menu-item" id="energieDivClick" onmouseenter="coloredEnergie(this)" onmouseleave="normalEnergie(this)" onclick="coloredEnergieClick(this)">
      <div class="menu-icon"><img id="energieImageClick" src="{{asset('public/images/Energies renouvelables.png')}}"/></div>
    </div>
    </a>
    <a href="#">
    <div class="menu-item" id="devDivClick" onmouseenter="coloredDev(this)" onmouseleave="normalDev(this)" onclick="coloredDevClick(this)">
      <div class="menu-icon"><img id="devImageClick" src="{{asset('public/images/Projet et developpement.png')}}"/></div>
    </div>
    </a>
    <a href="#">
    <div class="menu-item" id="exportationDivClick" onmouseenter="coloredExportation(this)" onmouseleave="normalExportation(this)" onclick="coloredExportationClick(this)">
      <div class="menu-icon"><img id="exportationImageClick" src="{{asset('public/images/Exportation.png')}}"/></div>
    </div>
    </a>
  </div>
  <div class="map">
<img id="productsMapClick" height="100%" src="{{asset('public/images/Map_All.png')}}"/>
</div>
  </div>
<!-- end mobile top --------------------------------------------------------->
<div class="numbersImage"><img  src="{{asset('public/images/numbersText.png')}}"/></div>
</div>
    ...
    <section >
      <div class="presentation1">
        ...
        <div class="presentation1-interior">
          ...
          <img src="{{asset('public/images/Image1.png')}}"/>
          </div>
        </div>
      ...
      <div class="presentation2">
        ...
        <div class="presentation1-interior">
        <div class="presentation1-image">
          <img src="{{asset('public/images/Image2.png')}}"/>
          </div>
        <div class="presentation1-text">
        <p>
...
la Tunisie, l'Italie, la Jordanie, l'Arabie Saoudite, l'Espagne et le Bahreïn.
        ...
        <div class="presentation1-image">
          <img src="{{asset('public/images/Image3.png')}}"/>
          </div>
...
<div class="slider">
    <div class="slide-container"><img src="{{asset('public/images/2006.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2007.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2008.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2009.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2010.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2011.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2012.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2013.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2014.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2015.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2016.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2017.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2018.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2019.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2020.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2021.png')}}"/></div>
    <div class="slide-container"><img src="{{asset('public/images/2022.png')}}"/></div>
...
function coloredCable(x){
    ...
    i.src="{{asset('public/images/cables et accessoires-Bl.png')}}";
    m.src="{{asset('public/images/Map_Cable.png')}}";
  }
  ...
  function normalCable(x){
    ...
    i.src="{{asset('public/images/cables et accessoires.png')}}";
    m.src="{{asset('public/images/Map_All.png')}}";
  }
  ...
  function coloredElectric(x){
    ...
    i.src="{{asset('public/images/Produits electriques-BL.png')}}";
    m.src="{{asset('public/images/Map_Produits_electriques.png')}}";
  }
  ...
  function normalElectric(x){
    ...
    d.style.background="none";
    i.src="{{asset('public/images/Produits electriques.png')}}";
    m.src="{{asset('public/images/Map_All.png')}}";
  }
  ...
  function coloredCompteurs(x){
    ...
    i.src="{{asset('public/images/Compteurs-BL.png')}}";
    m.src="{{asset('public/images/Map_Compteur.png')}}";
  }
  ...
  function normalCompteurs(x){
    ...
    d.style.background="none";
    i.src="{{asset('public/images/Compteurs.png')}}";
    m.src="{{asset('public/images/Map_All.png')}}";
  }
  ...
  function coloredTransformateurs(x){
    ...
    i.src="{{asset('public/images/Transformateurs-BL.png')}}";
    m.src="{{asset('public/images/Map_Transformateurs.png')}}";
  }
  ...
  function normalTransformateurs(x){
    ...
    d.style.background="none";
    i.src="{{asset('public/images/Transformateurs.png')}}";
    m.src="{{asset('public/images/Map_All.png')}}";
  }
  ...
  function coloredTel(x){
    ...
    i.src="{{asset('public/images/tel-BL.png')}}";
    m.src="{{asset('public/images/Map_tel.png')}}";
  }
  ...
  function normalTel(x){
    ...
    d.style.background="none";
    i.src="{{asset('public/images/Telcommunication.png')}}";
    m.src="{{asset('public/images/Map_All.png')}}";
  }
  ...
  function coloredEnergie(x){
    ...
    i.src="{{asset('public/images/Energies renouvelables-BL.png')}}";
    m.src="{{asset('public/images/Map_Energie.png')}}";
  }
  ...
  function normalEnergie(x){
    ...
    d.style.background="none";
    i.src="{{asset('public/images/Energies renouvelables.png')}}";
    m.src="{{asset('public/images/Map_All.png')}}";
  }
  ...
  function coloredDev(x){
    ...
    i.src="{{asset('public/images/Projet et developpement-BL.png')}}";
    m.src="{{asset('public/images/Map_Projets-et-developpement.png')}}";
  }
  ...
  function normalDev(x){
    ...
    d.style.background="none";
    i.src="{{asset('public/images/Projet et developpement.png')}}";
    m.src="{{asset('public/images/Map_All.png')}}";
  }
  ...
  function coloredExportation(x){
    ...
    i.src="{{asset('public/images/Exportation-BL.png')}}";
    m.src="{{asset('public/images/Map_Exportations.png')}}";
  }
  ...
  function normalExportation(x){
    ...
    d.style.background="none";
    i.src="{{asset('public/images/Exportation.png')}}";
    m.src="{{asset('public/images/Map_All.png')}}";
  }
</script>
