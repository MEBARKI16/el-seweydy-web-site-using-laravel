...
<!--APropos's section-->
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-xxl-8 col-xl-8 lg-8 col-md-8 col-sm-12 col-xm-12 mt-4">  
                <div class="row mb-3">
                    ...
                    <div class="col-xxl-2 col-xl-2 col-bg-2 col-md-2 col-sm-2 col-xm-2">
                        <button class="btn btn-danger text-upprcase text-left text-white" style="border-radius: 20px"><i>POSTULER</i></button>
                    </div>
                </div>
                <div class="row">
               ...
               <div class="row">
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xm-12">
                    <p class="text-justify text-capitalize text-dark" style="font-size: 15px; color: black; font-weight: 600">
                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="country" class="form-select d-block" id="country" style="font-size: 1rem" required>
                                            ...
                                            <?php $__currentLoopData = wilayas(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $wilaya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($id); ?>"><?php echo e($id); ?> - <?php echo e($wilaya); ?></option>
            ...
            <!-- a propos -->
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-0 col-xm-0">
                    <h1 class="text-uppercase text-center" style="font-size: 30px; font-weight: 900">à propos de nous</h1>
                    
                            <p class="text-justify text-dark" style="font-size: 15px; color: black; font-weight: 600">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/whitelineservices.dz/elsewedysite.whitelineservices.dz/elsewedyWebsite/elsewedyWebsite/resources/views/detail_offredemploi.blade.php ENDPATH**/ ?>