...
<div class="container pt-4">
            ...
            <div class="search-container">
                <form>
                    <div class="md-form my-0">
                      <input id="actSearchInput" class="form-control" type="text" placeholder="Recherche dans actualité" aria-label="Search">
                    </div>
    ...
    <div class="row pt-5 pb-5">
        <nav aria-label="Card pagination" style="background-color: brown;">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/whitelineservices.dz/elsewedysite.whitelineservices.dz/elsewedyWebsite/elsewedyWebsite/resources/views/actualite.blade.php ENDPATH**/ ?>