...
<!--APropos's section-->
    ...
    <div id="offredemploi_img" class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <img id="background-img" src="<?php echo e(asset('public/images/offredemploi/Banner_Offre_emploi.png')); ?>" alt="" style="position: relative;"> 
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/whitelineservices.dz/elsewedysite.whitelineservices.dz/resources/views/detail_offredemploi.blade.php ENDPATH**/ ?>