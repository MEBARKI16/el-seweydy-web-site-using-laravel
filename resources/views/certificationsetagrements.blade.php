 ...
 <style>
  ...
  @media only screen and (max-width: 760px){
    ...
    <div id="certeficat">
      ...
      <img src="{{asset('public/images/certifications_et_agrements_banner.webp')}}" alt="certifications_et_agrements_banner">
        <div>
    ...
    <!--Two blocs section-->
    <div id="prlbx" class="parallel-boxs">
        <div class="descreptive-box">
            <div class="box-header">
                <div class="box-title">Qualification et agréments</div>
                <div class="box-icon">
                  <img src="{{asset('public/images/quality.png')}}" alt="">
                </div>
            </div>
            <div class="box-separator"></div>
            <div class="box-text">
              <p style="color: white; ">Pour aller plus loin que la simple gestion d’actions d’amélioration et s’assurer de progresser dans la durée, rien de tel que de s’appuyer sur les meilleures pratiques professionnelles inscrites dans la norme leader dans le monde l’ISO 9001. EElsewedy Electric Algérie adopte la gestion qualité. Ainsi, pour le bien de ses clients et collaborateurs, Elsewedy
            ...
            <a href="{{asset('public/images/certifications_elsewedy.pdf')}}" target="_blank"><img src="{{asset('public/images/download.png')}}" alt="" href></a>
            </div>
        </div>
        <div class="boxs-separator"></div>
        <div class="descreptive-box">
            <div class="box-header">
                <div class="box-title" style="text-align: left">Qualité</div>
                <div class="box-icon">
                  <img src="{{asset('public/images/star.png')}}" alt="">
                </div>
            </div>
            <div class="box-separator"></div>
            <div class="box-text">
              <p style="color: white">Avec le challenge de conquérir de nouvelles parts de marché en Algérie et dans 
            ...
            <div class="download-button-box">
            <a href="{{asset('public/images/Elsewedy Cables Algeria SPA - COFRAC ISO 9001 .pdf')}}" target="_blank"><img src="{{asset('public/images/download.png')}}" alt="" ></a>
            </div>
        </div>
    </div>
