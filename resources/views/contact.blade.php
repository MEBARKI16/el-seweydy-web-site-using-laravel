...
<style>
    ...
    <div class="card text-white">
        <img class="card-img" src="{{ asset('public/images/WL_ELSEWEDY_Page_Contact_Elements/Artboard_93.png') }}" alt="Card image">
                        ...
                        <div id="text-padding">
                            <div class="d-flex align-items-center mb-3">
                                <div class="d-flex align-items-center justify-content-center flex-shrink-0">
                                    <img src="{{ asset('public/images/WL_ELSEWEDY_Page_Contact_Elements/Map.png') }}" style="height: 48px; width: 48px;" alt="">
                                </div>
                                <div class="ms-3">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="d-flex align-items-center justify-content-center flex-shrink-0">
                                    <img src="{{ asset('public/images/WL_ELSEWEDY_Page_Contact_Elements/Tel.png') }}" style="height: 48px; width: 48px;" alt="">
                                </div>
                                <div class="ms-3">
