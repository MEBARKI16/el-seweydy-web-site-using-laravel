 ...
 <?php $__env->startSection('content'); ?>
    ...
    <div id="offredemploi_img" class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <img id="background-img" src="<?php echo e(asset('public/images/offredemploi/Banner_Condidature_spontane.png')); ?>" alt="" style="position: relative;"> 
                    <div class="product container">
                    <h2 class="text-white text-left display-4" style="font-weight: 700px; font-size: 4rem;">Carrière</h2>
                    </div>
            </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="text-center">
                    <h1 class="text-uppercase" style="color: brown; font-weight: 700; text-align: center">Employeur de choix</h1>
                </div>
                <div class="text-left">
                    <p class="text-capitalize" style="font-weight: 400">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/whitelineservices.dz/elsewedysite.whitelineservices.dz/elsewedyWebsite/elsewedyWebsite/resources/views/offredemploi.blade.php ENDPATH**/ ?>