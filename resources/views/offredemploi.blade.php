                ...
                <div class="text-center">
                  ...
                  <div class="tab-pane fade show active" id="pills-cables" role="tabpanel" aria-labelledby="pills-cables-tab">
                      ...
                      <div class="portfolio-item">
                          ...
                          <img src="{{asset('public/images/offredemploi/Offre demploi.png')}}" alt="">
                          <div class="portfolio-overlay3">
                          <div class="button_savoir_plus">
                              <a type="button" class="savoir_plus" href="{{ route('candidaturespontane') }}" data-show="cable_garde_fibre_optiques" style="text-transform: uppercase; font-size: 10px; font-weight: 800">voir nos offres</a>
                          </div>
                          </div>
                      ...
                      <div class="portfolio-item">
                          ...
                          <img src="{{asset('public/images/offredemploi/Condidature spontanee.png')}}" alt="">
                          <div class="portfolio-overlay3">
                          <div class="button_savoir_plus">
                              <a type="button" class="savoir_plus" href="{{ route('candidaturespontane2') }}" data-show="cable_photovoltaique" style="text-transform: uppercase; font-size: 7px; font-weight: 800">déposer votre candidature</a>
                          </div>
