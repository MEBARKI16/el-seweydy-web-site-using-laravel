...
<?php $__env->startSection('content'); ?>
   ...
   <!-- <div class="row">
    ...
    <!--        <img src=" asset('public/images/WL_ELSEWEDY_Page_Contact_Elements/Artboard_93.png') " alt="">
              <div class="product container">
                <h2 class="text-white display-6">Contact</h2>
              </div>
          </section>
    </div>
    <br><br><br><br><br><br>  
        ...
        <div class="container">
            <div class="row">
                <div class="text-left wow fadeInUp" data-wow-delay="0.1s">
                    <p class="text-justify text-uppercase">Pour toute supplémentaire, nous vous invitions à prendre attache avec les membres de l'équipe Elsewedy Eletric Algérie à traveaux les différents contacts mise à votre disposition. Nous serions très honorés de pouvoir vous éclairer </p>
                </div>
            </div>
           
            <div class="row p-5">
                <!-- Siege Social -->
                <div id="overlapping_page" class="col-lg-4 col-md-6 col-sm-12">
                ...
                <!-- Contact form -->
                <div id="contact_form" class="col-lg-8 col-md-6 col-sm-12 col-xm-12">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/whitelineservices.dz/elsewedysite.whitelineservices.dz/elsewedyWebsite/elsewedyWebsite/resources/views/contact.blade.php ENDPATH**/ ?>