...
<div class="container pt-4">
    ...
    <div class="row pt-4">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                <img src="{{ url('public/images/WL_ELSWEDY_Elements_Page_Actualite/3032x1113/3.png') }}" alt="Slide 3" class="d-block w-100">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div style="display:flex;justify-context:flex-end">
                      <a id="lirelasuite" class="card-text" href="{{ route('detailevenement') }}"><p class="text-left">Lire La suite   </p><i class="fa fa-arrow-right" aria-hidden="true" style="color: brown; display: flex; padding-top: 12px; padding-left: 10px"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row pt-4">
        ...
        <div class="col-xxl-6 col-xl-6 col-md-6 col-sm-12 col-xm-12">
          <div class="card">
              <img class="card-img-top" src="{{ url('public/images/WL_ELSWEDY_Elements_Page_Actualite/3072x1113/3.png') }}" alt="Card image cap">
              <div class="card-body">
                  <h5 class="card-title btn btn-danger">National</h5>
                  <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                  <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
        ...
        <div class="col-xxl-6 col-xl-6 col-md-6 col-sm-12 col-xm-12">
            <div class="card">
                <img class="card-img-top" src="{{ url('public/images/WL_ELSWEDY_Elements_Page_Actualite/3072x1113/4.png') }}" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title btn btn-danger">National</h5>
                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
