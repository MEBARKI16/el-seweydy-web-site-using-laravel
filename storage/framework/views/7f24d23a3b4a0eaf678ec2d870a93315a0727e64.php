    ...
    <div class="container">
        <div class="row">
            <div id="employchoix" class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12" style="background-color: brown; border-radius: 50%">
               <img src="<?php echo e(asset('public/images/offredemploi/Artboard.png ')); ?>" alt="" class="rounded float-left pt-0"  >  <!-- style="max-width: 10rem; max-height: 10rem; position: relative" -->
            </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xm-10" style="padding-left: 10%; padding-right: 20%;">
                ...
                <br>
                <h3 id="envoicv" class="text-capitalize">Envoyer-nous votre <a href="<?php echo e(route('candidaturespontane2')); ?>" style="color: brown">candidature spontanée.</a></h3>
              </div>
              <br>
            </div>
          </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/whitelineservices.dz/elsewedysite.whitelineservices.dz/resources/views/candidaturespontane.blade.php ENDPATH**/ ?>