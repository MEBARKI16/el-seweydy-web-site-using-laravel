    ...
    <div id="acceil_text" class="mask" style="background-color: rgba(0, 0, 0, 0);">
      <div class="d-flex justify-content-center align-items-center h-100" style="float: left;">
        <div class="text-white" style="text-align: left;">
          ...
          <a href="<?php echo e(route('contact')); ?>"><button id="accueil_btn" type="button" class="btn btn-decouvrir-plus">Nous contacter</button></a>
        </div>
      </div>
    </div>
  </header>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\elseweydy-amine\resources\views/index.blade.php ENDPATH**/ ?>