...
<html lang="en">
  ...
  <body data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <div class="container">
      <div class="row">
        <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-4 col-sm-2 col-xm-1"></div>
        <div id="redirectedurl" class="col-xxl-5 col-xl-5 col-lg-5 col-md-8 col-sm-10 col-xm-11" style="text-align: right;">
            ...
            <form method="POST" action="<?php echo e(url('newsletterSubscribe')); ?>" class="p-2">
                <?php echo csrf_field(); ?>
              <div class="row form-inscription">Inscrivez-vous à notre newsletter et restez à jour ! </div>
  ...
  <footer class="mt-auto" style="background-color: #b30023;">
    <div class="container pt-2 pb-2"> 
      <div class="row pt-2">
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-4 col-xm-4" style="text-align: center">
            <p class="text-capitalize" style="color: white">Copyright &copy; <?php
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-8 col-xm-8" style="text-align: center">
          <ul class="list-inline">
            ...
            <li class="list-inline-item">
              <a href="#">
                <i class="fab fa-twitter fa-spin fa-lg" style="color: #96afd9;"></i>
              </a>
            </li>
            <li class="list-inline-item">
              <a href="#">
                <i class="fab fa-instagram fa-lg" style="color: #511f1f;"></i>
              </a>
            </li>
            
            <li class="list-inline-item">
              <a href="#">
                <i class="fab fa-youtube fa-lg fa-spin" style="color: #f20707;"></i>
              </a>
            </li>
...
</html><?php /**PATH /var/www/vhosts/whitelineservices.dz/elsewedysite.whitelineservices.dz/resources/views/layouts/main.blade.php ENDPATH**/ ?>